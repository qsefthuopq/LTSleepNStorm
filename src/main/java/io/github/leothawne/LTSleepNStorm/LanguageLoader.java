...
public class LanguageLoader {
	public static final void check(LTSleepNStorm plugin, ConsoleLoader myLogger, FileConfiguration configuration) {
	...
	public static final FileConfiguration load(LTSleepNStorm plugin, ConsoleLoader myLogger, FileConfiguration configuration) {
